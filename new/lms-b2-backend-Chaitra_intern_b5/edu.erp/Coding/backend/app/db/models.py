...
class IEMSAcademicBatch(Base):
    ...
    academic_batch_owner = Column(Integer)
...
class IEMSUserRoleMaster(Base):
    ...
    user_role = Column('role_name', String(45), nullable=False)
    user_role_description = Column('description', String(225), nullable=False)
    status = Column(SmallInteger, default=1, nullable=False)
...
class Student(Base):
    ...
    erp_student_id = Column("student_id", Integer, primary_key=True, index=True)
    first_name = Column("first_name", String(45), nullable=True)
    last_name = Column("last_name", String(45), nullable=True)
    email_id = Column("email", String(45), nullable=True)
    erp_dept_id = Column("department_id", Integer, nullable=True)
    erp_student_usn = Column("usno", String(20), nullable=False)
    full_name = Column("name", String(150), nullable=True)
    erp_crclm_id = Column("academic_batch_id", Integer, nullable=True)
...
class LMSConfigType(Base):
    ...
    id = Column("config_type_id", MEDIUMINT, primary_key=True, autoincrement=True)
    config_type = Column(String(255), nullable=False)
    min_mentees = Column(Integer, nullable=False, default=1)
    max_mentees = Column(Integer, nullable=False, default=10)
    org_id = Column(Integer, nullable=True)
    status = Column(Integer, default=1)
    created_by = Column(Integer, nullable=True)
    modified_by = Column(Integer, nullable=True)
...
class LMSCrossDeptMentor(Base):
    """
    Tracks cross-department mentor assignments.
    A row here means:  mentor_user_id (from mentor_dept_id) is mentoring
    in assigned_dept_id (a different department within the same org).
    """
    __tablename__ = "lms_cross_dept_mentor"

    id = Column(Integer, primary_key=True, autoincrement=True)
    mentor_user_id = Column(Integer, nullable=False)   # iems_users.id
    mentor_dept_id = Column(Integer, nullable=False)   # mentor's home dept
    assigned_dept_id = Column(Integer, nullable=False) # dept they mentor in
    curriculum_id = Column(Integer, nullable=True)     # curriculum.crclm_id
    org_id = Column(Integer, nullable=True)
    status = Column(Integer, default=1)                # 1=active, 0=removed
    created_by = Column(Integer, nullable=True)
    modified_by = Column(Integer, nullable=True)
    create_date = Column(DateTime, nullable=True)
    modify_date = Column(DateTime, nullable=True)
class LMSMentorsGroup(Base):
    ...
    mentors_pgm_title = Column(String(100), nullable=True)
    created_by = Column(Integer, nullable=False)
    modified_by = Column(Integer, nullable=True)
...
class LMSMentorsGroupTerms(Base):
    ...
    mentors_group_terms_id = Column(Integer, primary_key=True, autoincrement=True)
...
class LMSGroupMentors(Base):
    ...
    group_mentor_id = Column(Integer, primary_key=True, autoincrement=True)
...
class LMSGroupMentees(Base):
    ...
    group_mentee_id = Column(Integer, primary_key=True, autoincrement=True)
    mentors_group_terms_id = Column(Integer, nullable=False)
...
class LMSMentoringSchedule(Base):
    ...
    session_agenda = Column(String(1000), nullable=True)
    created_by = Column(Integer, nullable=False)
    modified_by = Column(Integer, nullable=True)
    created_date = Column(DateTime, default=func.now())
    modified_date = Column(DateTime, default=func.now(), onupdate=func.now())
...
class LMSMentoringSubGrpDate(Base):
    ...
    sub_group_date_id = Column(Integer, primary_key=True, autoincrement=True)
...
class LMSQuestionnaires(Base):
    ...
    questionnaire_id = Column(Integer, primary_key=True, autoincrement=True)
    questionnaire_name = Column(String(100), nullable=False)
    message_to_mentees = Column(Text, nullable=True)
...
class LMSQuestionnairesQuestions(Base):
    ...
    questionnaire_id = Column(Integer, nullable=True)
    que_type_id = Column(Integer, nullable=True)
    que_no = Column(Integer, nullable=False)
    question = Column(Text, nullable=False)
    questionnaire_type_id = Column(Integer, nullable=True)
...
class LMSQuestionnairesOptions(Base):
    ...
    questionnaire_options_id = Column(Integer, primary_key=True, autoincrement=True)
    questionnaire_que_id = Column(Integer, nullable=True)
    que_option = Column(String(300), nullable=False)
...
class LMSMenteeQuestionnaireResponse(Base):
    ...
    questionnaire_response_id = Column(Integer, primary_key=True, autoincrement=True)
    student_id = Column(Integer, nullable=False)
    questionnaire_id = Column(Integer, nullable=False)
    schedule_id = Column(Integer, nullable=False)
    sub_group_id = Column(Integer, nullable=True)
    sub_group_date_id = Column(Integer, nullable=True)
    created_by = Column(Integer, nullable=False)
    modified_by = Column(Integer, nullable=True)
    created_date = Column(DateTime, default=func.now())
    modified_date = Column(DateTime, default=func.now(), onupdate=func.now())
...
class LMSMenteeQuestionnaireResponseQue(Base):
    ...
    questionnaire_response_que_id = Column(Integer, primary_key=True, autoincrement=True)
    questionnaire_response_id = Column(Integer, nullable=False)
    questionnaire_que_id = Column(Integer, nullable=False)
...
class LMSMenteeQuestionnaireResponseOption(Base):
    ...
    questionnaire_response_option_id = Column(Integer, primary_key=True, autoincrement=True)
    questionnaire_response_que_id = Column(Integer, nullable=False)
    questionnaire_options_id = Column(Integer, nullable=False)
...
class LMSMMPSessionSuggestion(Base):
    ...
    session_suggestion_id = Column(Integer, primary_key=True, autoincrement=True)
...
class LMSMMPSessionSuggestionGenericComments(Base):
    ...
    generic_comment_id = Column(Integer, primary_key=True, autoincrement=True)
    session_suggestion_id = Column(Integer, nullable=True)
    comment = Column(String(2000), nullable=True)
    attachment = Column(String(200), nullable=True)
    suggestion_type = Column(Boolean, default=False)
...
class LMSMMPSessionSuggestionIndividualComments(Base):
    ...
    individual_comment_id = Column(Integer, primary_key=True, autoincrement=True)
    session_suggestion_id = Column(Integer, nullable=True)
    comment = Column(String(2000), nullable=True)
    attachment = Column(String(200), nullable=True)
    suggestion_type = Column(Boolean, default=False)
    from_user_id = Column(Integer, nullable=True)
    mentee_id = Column(Integer, nullable=True)
    from_user_type = Column(Boolean, default=False)
    created_by = Column(Integer, nullable=True)
    modified_by = Column(Integer, nullable=True)
    created_date = Column(DateTime, default=func.now())
    modified_date = Column(DateTime, default=func.now(), onupdate=func.now())
...
class LMSMentoringSubGrpMentee(Base):
    """Maps mentees (students) to a specific sub-group in a mentoring session."""
    __tablename__ = 'lms_mentoring_sub_grp_mentee'
    sub_grp_mentee_id = Column(Integer, primary_key=True, autoincrement=True)
    sub_group_id = Column(Integer, nullable=False)
    schedule_id = Column(Integer, nullable=False)
    student_id = Column(Integer, nullable=False)
    created_by = Column(Integer, nullable=True)
